...
<%- renderer.minify(include('/examples/example', { name: 'counter' })) %>
...
<%- renderer.minify(include('/examples/example', { name: 'fancy-counter' })) %>
...
<%- renderer.minify(include('/examples/example', { name: 'filterable-list' })) %>
